...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.CadornaCoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.CadornaCointools.com", true);
        vSeeds.emplace_back("dnsseed.CadornaCoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.CadornaCointools.com", true);
        vSeeds.emplace_back("seed-b.CadornaCoin.loshan.co.uk", true);
