...
const char * const BITCOIN_CONF_FILENAME = "CadornaCoin.conf";
const char * const BITCOIN_PID_FILENAME = "CadornaCoin.pid";
...
#else
    const char* pszModule = "CadornaCoin";
#endif
    if (pex)
        return strprintf(
