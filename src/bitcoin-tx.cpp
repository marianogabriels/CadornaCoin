...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s CadornaCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  CadornaCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CadornaCoin transaction") + "\n" +
              "  CadornaCoin-tx [options] -create [commands]   " + _("Create hex-encoded CadornaCoin transaction") + "\n" +
              "\n";
